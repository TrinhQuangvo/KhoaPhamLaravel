			...
			<div class="container">
				...
				<div class="pull-right auto-width-right">
					<ul class="top-details menu-beta l-inline">
						...
						@if(Auth::check())
						<li><a href="{{route('login')}}">Chào Bạn , {{Auth::user()->fullname}}</a></li>
						...
						<div class="cart">
							...
							<div class="beta-dropdown cart-body">
								...
								<a href="{{route('xoagiohang',$product['item']['id'])}}" class="cart-item-delete"><i class="fa fa-times"></i></a>
									<div class="media">
										<a class="pull-left" href="#"><img src="source/image/product/{{$product['item']['image']}}"  height="90px" width="120px" alt=""></a>
